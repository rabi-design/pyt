...
from scrape.bs_req import bs_req
...
def help_s():
    ...
    li, no = bs_req("https://chromedriver.chromium.org/downloads")
...
def expand_shadow_element_gfp(driver):
    driver.get("https://chrome.google.com/webstore/detail/gofullpage-full-page-scre/fdpohaocaechififmbbbbbknoalclacl?hl=ja")
    sleep(5)
